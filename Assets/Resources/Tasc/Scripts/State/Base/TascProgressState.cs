...
namespace Tasc
{
    ...
    {
        public static TascProgressState Idle = new TascProgressState(1000, "Idle", "Task is not initiated.");
        public static TascProgressState Started = new TascProgressState(1001, "Started", "Task is in progress.");
        public static TascProgressState Ended = new TascProgressState(1002, "Ended", "Task is terminated.");
