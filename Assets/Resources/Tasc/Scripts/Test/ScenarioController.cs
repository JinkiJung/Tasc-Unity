...
namespace Tasc
{
    public class ScenarioController : MonoBehaviour
    {
        ...
        {
            scenario.LoadFromJSON(scenarioJSON);
            //MakeTestScenario();
        }
        ...
        void MakeTestScenario()
        {
            ...
            test2.exit = new Condition(new TascState(test2, TascProgressState.Started), RelationalOperator.Equal);
            scenario.Add(test2);
            ...
            test3.exit = new Condition(new TascState(test3, TascProgressState.Started), RelationalOperator.Equal, new TimeState(0, 0, 1));
            scenario.Add(test3);
            ...
            /*
            //introduction.exit = new Condition(new TascState(introduction, TascProgressState.Started), Condition.Operator.Equal, new TimeState(0,0,1));
            introduction.exit = new Condition(new Condition(new TascState(introduction, TascProgressState.Started), Condition.RelationalOperator.Equal, new TimeState(0, 0, 1)),
